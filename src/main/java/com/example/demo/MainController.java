...
//                }
                if(groupChat != null){
                    ArrayList<Message> messages = groupChat.messages;
                    int[] listSizeContainer = {messages.size()};

//                    TimerTask task = new TimerTask() {
//                        @Override
//                        public void run() {
//                            if(messages.size() > listSize){
//                                MouseEvent mouseEvent = new MouseEvent(MouseEvent.MOUSE_CLICKED, 0, 0, 0, 0, MouseButton.PRIMARY, 1, true, true, true, true, true, true, true, true, true, true, null);
//                                Event.fireEvent(userHBox, mouseEvent);
//                            }
//                        }
//                    };
                    ...
                    timer.scheduleAtFixedRate(new TimerTask() {
                        ...
                        public void run() {
                            Platform.runLater(() -> {
                                if(messages.size() > listSizeContainer[0]){
                                    MouseEvent mouseEvent = new MouseEvent(MouseEvent.MOUSE_CLICKED, 0, 0, 0, 0, MouseButton.PRIMARY, 1, true, true, true, true, true, true, true, true, true, true, null);
                                    Event.fireEvent(userHBox, mouseEvent);
                                }

                                listSizeContainer[0] = messages.size();
                            });
                        }
                    }, 0, 1000);
                }
                                ...
                                if (hbox.equals(targetHBox)) {
                                    ...
                                    try{
                                        ...
                                        client2.editMessage(labelToFind.getText(), i, newMsg);
                                            ...
                                            client2.editGroupMessage(labelToFind.getText(),i,newMsg);
                                        }
